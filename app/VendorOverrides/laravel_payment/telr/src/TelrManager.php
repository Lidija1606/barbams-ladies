...
class TelrManager
{
     ...
     */
    public function prepareCreateRequest($orderId, $amount, $currency, $description, array $billingParams = [])
    {
     ...
     * @throws \Exception
     */
    public function pay($orderId, $amount, $currency, $description, array $billingParams = [])
    {
        $createRequest = $this->prepareCreateRequest($orderId, $amount, $currency, $description, $billingParams);
