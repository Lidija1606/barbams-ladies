...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; margin-bottom: 30px" class="background">
	...
	max-width: 500px;" class="wrapper">
			...
			padding-top: 15px;
			color: #FFFFFF;
            font-family: 'Gotham Bold';  line-height: 130%; cursor: pointer;
			" class="paragraph">
                            {!! trans('mail.shippingTrackingUrl') !!}
                        </td>
                    </tr>
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px;
			...
			padding-bottom: 5px;" class="button">
					...
					color: #FFFFFF;  font-size: 17px; font-weight: 400; line-height: 120%;" href="<?php echo (\App\Helpers\Helper::getVisitorCountryCode() == 'AE') ? 'https://www.facebook.com/' : 'https://www.facebook.com/barbamselixir/' ?>">
                                        <img src="https://barbams.com/img/social/facebook-icon.png" width="30px" alt="Barbams Facebook page">
                                    </a>
                                </td>
                                <td align="center" valign="middle">
                                    <a target="_blank" style="text-decoration: underline;
					color: #FFFFFF;  font-size: 17px; font-weight: 400; line-height: 120%;" href="<?php echo (\App\Helpers\Helper::getVisitorCountryCode() == 'AE') ? 'https://instagram.com/barbams.middleeast' : 'https://instagram.com/barbams.europe' ?>">
